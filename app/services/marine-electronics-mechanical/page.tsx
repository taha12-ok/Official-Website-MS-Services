...
import { Laptop, ArrowLeft, CheckCircle, Award, TrendingUp, X, ChevronLeft, ChevronRight, Droplets, Car, Package, Sun, LifeBuoy, Plane, Zap, Wrench, Cpu } from 'lucide-react';
    ...
    <div className="relative min-h-screen bg-white dark:bg-neutral-950">
      ...
      <section className="py-32 px-4">
        <motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="max-w-4xl mx-auto text-center p-16 rounded-3xl bg-neutral-100 dark:bg-neutral-900 border border-neutral-200 dark:border-neutral-800">
          ...
          <p className="text-xl text-neutral-600 dark:text-neutral-400 mb-10 max-w-2xl mx-auto">Contact us today to discuss your IT solutions project.</p>
