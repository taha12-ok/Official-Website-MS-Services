...
// Scroll detection via useSyncExternalStore — avoids extra re-renders from useState+useEffect polling
...
export default function Navigation() {
  ...
  return (
    <>
      {/* Single positioning wrapper — sticky, never animates position, only visual states */}
      <div
      ...
      >
        ...
        >
            ...
            <div className="max-w-7xl mx-auto px-3 sm:px-4 lg:px-8">
              <div className="flex items-center justify-between h-8 sm:h-10 text-[10px] sm:text-xs md:text-sm">
                <div className="flex items-center gap-2 sm:gap-4 text-neutral-400">
                  ...
                  <a href="mailto:msservicesandtrading@gmail.com" className="hidden sm:flex items-center gap-1 sm:gap-2 hover:text-white transition-colors group focus-ring rounded">
                    <Mail className="w-3 h-3 sm:w-3.5 sm:h-3.5 group-hover:scale-125 transition-transform duration-300 ease-out motion-reduce:transition-none motion-reduce:group-hover:scale-100" />
          ...
          {/* Main Nav Row */}
          <div className={`max-w-7xl mx-auto transition-all duration-300 ease-out ${isScrolled ? 'px-4 sm:px-6' : 'px-3 sm:px-4 lg:px-8'}`}>
            <div className={`flex items-center justify-between transition-all duration-300 ease-out ${isScrolled ? 'h-14 sm:h-16' : 'h-16 sm:h-20'}`}>
              {/* Animated Logo */}
                  ...
                  return (
                    ...
                    >
                      <a
                        ...
                        className={`flex items-center gap-1 px-3 xl:px-4 py-2 rounded-xl font-semibold transition-all relative overflow-hidden text-sm focus-ring ${
                          active
                      ...
                      >
                        ...
                        {item.submenu && (
                          <ChevronDown
                            size={16}
                            className={`transition-transform duration-300 ease-out relative z-10 motion-reduce:transition-none ${activeSubmenu === item.name ? 'rotate-180' : ''}`}
                          />
                        )}
                      </a>
                      {item.submenu && (
                                ...
                                {item.submenu.map((subitem, subidx) => (
                                  ...
                                  >
                                    <a
                                      ...
                                      className={`block px-4 py-3 rounded-xl text-sm transition-all group focus-ring ${
                                    ...
                                    >
                                      <span className="flex items-center gap-2">
                                        <span className={`w-1 h-1 rounded-full transition-all duration-300 ease-out motion-reduce:transition-none ${
                                          pathname === subitem.href
              ...
              <div className="flex items-center gap-2 sm:gap-3">
                <motion.button
                  ...
                  className="p-1.5 sm:p-2 rounded-lg sm:rounded-xl bg-neutral-100/50 dark:bg-neutral-800/50 backdrop-blur-xl border border-neutral-200/50 dark:border-white/10 hover:bg-neutral-200/50 dark:hover:bg-neutral-700/50 transition-all focus-ring"
                >
                ...
                <motion.button
                  ...
                  className="lg:hidden p-1.5 sm:p-2 rounded-lg sm:rounded-xl bg-neutral-100/50 dark:bg-neutral-800/50 backdrop-blur-xl border border-neutral-200/50 dark:border-white/10 focus-ring"
                >
